...
$modx_core_path             = 'path/to/installed/modx/core/';
$modx_processors_path       = 'path/to/installed/modx/core/model/modx/processors/';
$modx_connectors_path       = 'path/to/installed/modx/connectors/';
$modx_connectors_url        = '/connectors/';
$modx_manager_path          = 'path/to/installed/modx/manager/';
$modx_manager_url           = '/manager/';
$modx_base_path             = 'path/to/installed/modx/waabeh.com/';
$modx_base_url              = '/';
$modx_assets_path           = 'path/to/installed/modx/assets/';
