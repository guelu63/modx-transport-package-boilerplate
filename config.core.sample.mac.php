...
$modx_core_path             = '/Applications/MAMP/htdocs/modx/core/';
$modx_processors_path       = '/Applications/MAMP/htdocs/modx/core/model/modx/processors/';
$modx_connectors_path       = '/Applications/MAMP/htdocs/modx/connectors/';
$modx_connectors_url        = '/connectors/';
$modx_manager_path          = '/Applications/MAMP/htdocs/modx/manager/';
$modx_manager_url           = '/manager/';
$modx_base_path             = '/Applications/MAMP/htdocs/modx/waabeh.com/';
$modx_base_url              = '/';
$modx_assets_path           = '/Applications/MAMP/htdocs/modx/assets/';
